...
class TimesliceGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.type_combo.addItems(["垂直切片", "水平切片", "圆形切片"])
        ...
        self.type_combo.currentIndexChanged.connect(self.update_position_combo)
        ...
        self.auto_open_check = QCheckBox("完成后自动打开图片")  # 添加自动打开选项
    ...
    def update_position_combo(self, index):
        # 根据切片类型更新位置选项
